...
def _train_loader_from_config(cfg, *, train_set=None, transforms=None, sampler=None, **kwargs):
    ...
    if sampler is None:
        sampler_name = cfg.DATALOADER.SAMPLER_TRAIN#NaiveIdentitySampler
        ...
        elif sampler_name == "CVIdentitySampler":
            sampler = samplers.CVIdentitySampler(train_set.img_items, mini_batch_size, num_instance)
