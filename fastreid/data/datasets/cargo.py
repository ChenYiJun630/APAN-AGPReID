...
class CARGO_AG(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        self.root = root
        self.data_dir = '/workspace/AGReID/Datasets/CARGO/'
...
#         train = self.process_dir(self.train_dir, is_train=True)
#         query = self.process_dir(self.query_dir, is_train=False,view='Aerial')
#         gallery = self.process_dir(self.gallery_dir, is_train=False,view='Ground')
